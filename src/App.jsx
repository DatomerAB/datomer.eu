...
const FALLBACK_DOWNLOAD_URL =
  'https://github.com/DatomerAB/par-releases/releases/download/v0.1.9-beta.2026091403/Par_0.1.9-beta.2026091403_aarch64.dmg'
...
function useDownloadUrl() {
  ...
  useEffect(() => {
    ...
    fetch('https://raw.githubusercontent.com/DatomerAB/par-releases/main/latest.json?tag=v0.1.9-beta.2026091403')
