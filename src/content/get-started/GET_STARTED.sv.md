<p align="center">
  <img src="/get-started/par-banner.webp" alt="Pär — Din AI. Din enhet. Din data." width="100%" style="border-radius: 18px; box-shadow: 0 4px 20px rgba(0,0,0,0.35);" />
</p>

# <img src="/get-started/par-logo.webp" alt="Pär-logotyp" width="40" height="40" style="border-radius: 10px; vertical-align: middle; margin-right: 6px;" />Pär
...
## Vad kan du göra med Pär?

Pär är utformat för att kännas enkelt, hjälpsamt och helt privat från dag ett. Så här kan du använda appen:
...
### 2. ⚡ Act — Automatisera din dag
- **Kör smidiga rutiner** — Förvandla råa mötesanteckningar till åtgärdspunkter, skriv utkast till sammanfattningar eller få en daglig briefing med ett klick.
- **Gör idéer till uppgifter** — När en rutin hittar saker du behöver göra kan den automatiskt skapa att göra-punkter åt dig.
- **Personliga personas** — Lär Pär olika roller (som *Skrivcoach*, *Teknikrådgivare* eller *Pluggkompis*) som anpassar hur du får hjälp.

<p align="center">
  <img src="/get-started/act-screen.webp" alt="Pär Act — rutiner och automatisering" width="100%" style="border-radius: 12px; border: 1px solid #333; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
</p>

### 3. 📝 Uppgifter — Håll ordning på dig själv
- **Fånga att göra-punkter direkt från chatten** — Spara åtgärdspunkter som dyker upp i dina konversationer direkt i din uppgiftslista.
- **Enkel, tydlig uppföljning** — Sortera uppgifter efter Hög, Medel eller Låg prioritet, bocka av dem när du blir klar och se vad som ska vara klart idag eller imorgon.
- **Exportera när som helst** — Exportera dina listor när du vill dela dem eller ta dem någon annanstans.

<p align="center">
  <img src="/get-started/tasks-screen.webp" alt="Pär Uppgifter — att göra-lista och åtgärdspunkter" width="100%" style="border-radius: 12px; border: 1px solid #333; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
</p>
...
| Du behöver | Varför |
|---|---|
| En Mac med Apple Silicon (M1, M2, M3, M4…) | Pär använder din Macs chip för att tänka |
| macOS 11 (Big Sur) eller nyare | Klicka på Apple-logotypen  → *Om denna Mac* för att kontrollera |
...
<p align="center">
  <img src="/get-started/par-logo.webp" alt="Pär App-ikon" width="80" height="80" style="border-radius: 18px; vertical-align: middle; margin-right: 14px;" />
  <span style="font-size: 28px; vertical-align: middle; color: #888;">➔</span>
  <span style="font-size: 32px; vertical-align: middle; margin-left: 14px;">📁 <b>Program</b></span>
</p>

3. **Dra Pär till Program-mappen** ➔ det är hela installationen!
4. Stäng fönstret och **mata ut** skivavbilden (klicka på ⏏ bredvid "Pär" i Finders sidofält)
...
**4 · Allt är klart**
Klicka på **Börja använda Pär →** så är du igång.

---

## 3. Ladda ner din hjärna 🧠 — 5–15 minuter

En **AI-modell** är den del som faktiskt tänker. Det är en enda stor fil som du laddar ner **en gång** och behåller för alltid.

### Alternativ A: Under första installationen (Enklast)
På **Steg 3 (Välj din AI-modell)** i välkomstguiden väljer Pär automatiskt det bästa alternativet för din hårdvara. Klicka på:

> ### **`Ladda ner rekommenderad modell`**

Medan den laddas ner visar Pär en kort interaktiv genomgång av vad appen kan göra. ☕️

---

### Alternativ B: Från modellsidan (När som helst)
Du kan utforska, ladda ner och byta modeller när du vill:
...
4. Hitta modellen med den blå **`Ladda ner`**-knappen (t.ex. **Qwen 7B** eller **Qwen 14B**) och klicka på den.
5. När nedladdningen är klar ändras märket till grönt med **✓ Redo**.
...
Skriv i fältet längst ner och tryck på **Retur**.

Prova något av detta:
- *"Hjälp mig att skriva ett artigt mejl där jag tackar nej till ett möte."*
- *"Förklara ränta-på-ränta som om jag vore tolv år."*
- *"Vad ska jag tänka på när jag köper en begagnad bil?"*

> 💡 **Praktiska tips:**
> - Tryck på `Retur` för att skicka, eller `Skift + Retur` för ny rad.
> - Tryck på `⌘K` för att öppna snabbmenyn.
> - Byt tonläge när som helst med tonlägesväljaren (*Vänlig*, *Professionell*, *Koncis*, *Övertygande*, *Verkställande*) precis bredvid inmatningsfältet.

**Koppla bort ditt Wi-Fi och prova igen.** Det fungerar fortfarande. Det är hela poängen. ✈️

---

## Har du en licensnyckel?

Om du har fått en licensnyckel eller inbjudningskod (en lång rad bokstäver och siffror) kan du låsa upp extra funktioner:

**Meny ☰ → Licens → klistra in din nyckel → Aktivera**

Du ser *"Aktiverad — välkommen till Pär…"* och ditt nya märke visas direkt. Inget konto, ingen inloggning, ingen e-postadress behövs.
...
**Pär är en hjälpsam assistent, inte en fackexpert.** Pär är inte läkare, jurist, psykoterapeut eller ekonomisk rådgivare. För viktiga frågor, vänd dig till en riktig expert. Om du befinner dig i en nödsituation, kontakta larmcentralen (112).
...
<p align="center">
  ...
  <br/>
  <em>Pär — av Datomer AB. Utvecklat inom EU med privacy-by-design, konstruerat för fullständig datasuveränitet och offline-driftsäkerhet.</em>
</p>
