export const translations = {
  en: {
    ...
    press: {
      ...
      downloadLinkedInBanner: 'Download LinkedIn banner (PNG)',
      parBrandMaterials: 'Pär Brand Materials',
      parBrandMaterialsText: 'Product-level Pär assets styled with the same professional themes as the Datomer company images.',
      downloadParLogoPng: 'Download Pär themed logo (PNG)',
      downloadParBannerPng: 'Download Pär themed banner (PNG)',
      downloadParVariant: 'Download Pär {{variant}} banner',
      parVariantAlt: 'Pär {{variant}} banner variant',
      parLogoVariations: 'Themed Pär Logo Variations',
      parLogoVariationsText: 'Transparent Pär logo variations in every theme colour, including silver, platinum and gold.',
      downloadParLogoVariant: 'Download Pär {{variant}} themed logo',
      parLogoVariantAlt: 'Pär {{variant}} themed logo variant',
      parBannerVariations: 'Themed Pär Banner Variations',
      parBannerVariationsText: 'Pär banner variations for LinkedIn and other channels.',
      datomerBrandMaterials: 'Datomer Brand Materials',
      datomerBrandMaterialsText: 'Company-level assets for Datomer AB, styled with the same professional themes as the Pär product images.',
      downloadDatomerLogoPng: 'Download Datomer themed logo (PNG)',
      downloadDatomerBannerPng: 'Download Datomer themed banner (PNG)',
      downloadDatomerVariant: 'Download Datomer {{variant}} banner',
      datomerVariantAlt: 'Datomer {{variant}} banner variant',
      datomerLogoVariations: 'Themed Datomer Logo Variations',
      datomerLogoVariationsText: 'Transparent Datomer logo variations in every theme colour, including silver, platinum and gold.',
      downloadDatomerLogoVariant: 'Download Datomer {{variant}} themed logo',
      datomerLogoVariantAlt: 'Datomer {{variant}} themed logo variant',
      datomerBannerVariations: 'Themed Datomer Banner Variations',
      datomerBannerVariationsText: 'Datomer banner variations for LinkedIn and other channels.',
  ...
  sv: {
    ...
    press: {
      ...
      downloadLinkedInBanner: 'Ladda ner LinkedIn-banner (PNG)',
      parBrandMaterials: 'Pär varumärkestillgångar',
      parBrandMaterialsText: 'Produktnivå-tillgångar för Pär, utformade med samma professionella teman som Datomers företagsbilder.',
      downloadParLogoPng: 'Ladda ner Pär-tematisk logotyp (PNG)',
      downloadParBannerPng: 'Ladda ner Pär-tematisk banner (PNG)',
      downloadParVariant: 'Ladda ner Pär {{variant}}-banner',
      parVariantAlt: 'Pär {{variant}} bannervariant',
      parLogoVariations: 'Tematiska Pär-logovarianter',
      parLogoVariationsText: 'Transparenta Pär-logovarianter i alla temafärger, inklusive silver, platina och guld.',
      downloadParLogoVariant: 'Ladda ner Pär {{variant}}-tema logotyp',
      parLogoVariantAlt: 'Pär {{variant}} tema logotyp variant',
      parBannerVariations: 'Tematiska Pär-bannervarianter',
      parBannerVariationsText: 'Pär-bannervarianter för LinkedIn och andra kanaler.',
      datomerBrandMaterials: 'Datomer varumärkestillgångar',
      datomerBrandMaterialsText: 'Företagsnivå-tillgångar för Datomer AB, utformade med samma professionella teman som Pärs produktbilder.',
      downloadDatomerLogoPng: 'Ladda ner Datomer-tematisk logotyp (PNG)',
      downloadDatomerBannerPng: 'Ladda ner Datomer-tematisk banner (PNG)',
      downloadDatomerVariant: 'Ladda ner Datomer {{variant}}-banner',
      datomerVariantAlt: 'Datomer {{variant}} bannervariant',
      datomerLogoVariations: 'Tematiska Datomer-logovarianter',
      datomerLogoVariationsText: 'Transparenta Datomer-logovarianter i alla temafärger, inklusive silver, platina och guld.',
      downloadDatomerLogoVariant: 'Ladda ner Datomer {{variant}}-tema logotyp',
      datomerLogoVariantAlt: 'Datomer {{variant}} tema logotyp variant',
      datomerBannerVariations: 'Tematiska Datomer-bannervarianter',
      datomerBannerVariationsText: 'Datomer-bannervarianter för LinkedIn och andra kanaler.',
  ...
  de: {
    ...
    press: {
      ...
      downloadLinkedInBanner: 'LinkedIn-Banner herunterladen (PNG)',
      parBrandMaterials: 'Pär Markenmaterialien',
      parBrandMaterialsText: 'Produktbezogene Assets für Pär, gestaltet mit denselben professionellen Themen wie die Datomer-Unternehmensbilder.',
      downloadParLogoPng: 'Pär-Logo im Themen-Design herunterladen (PNG)',
      downloadParBannerPng: 'Pär-Banner im Themen-Design herunterladen (PNG)',
      downloadParVariant: 'Pär {{variant}}-Banner herunterladen',
      parVariantAlt: 'Pär {{variant}} Bannervariante',
      parLogoVariations: 'Pär Logo-Variationen im Themen-Design',
      parLogoVariationsText: 'Transparente Pär-Logo-Variationen in allen Themenfarben, einschließlich Silber, Platin und Gold.',
      downloadParLogoVariant: 'Pär {{variant}}-Themen-Logo herunterladen',
      parLogoVariantAlt: 'Pär {{variant}} Themen-Logo Variante',
      parBannerVariations: 'Pär Banner-Variationen im Themen-Design',
      parBannerVariationsText: 'Pär-Banner-Variationen für LinkedIn und andere Kanäle.',
      datomerBrandMaterials: 'Datomer Markenmaterialien',
      datomerBrandMaterialsText: 'Unternehmensweite Assets für Datomer AB, gestaltet mit denselben professionellen Themen wie die Pär-Produktbilder.',
      downloadDatomerLogoPng: 'Datomer-Logo im Themen-Design herunterladen (PNG)',
      downloadDatomerBannerPng: 'Datomer-Banner im Themen-Design herunterladen (PNG)',
      downloadDatomerVariant: 'Datomer {{variant}}-Banner herunterladen',
      datomerVariantAlt: 'Datomer {{variant}} Bannervariante',
      datomerLogoVariations: 'Datomer Logo-Variationen im Themen-Design',
      datomerLogoVariationsText: 'Transparente Datomer-Logo-Variationen in allen Themenfarben, einschließlich Silber, Platin und Gold.',
      downloadDatomerLogoVariant: 'Datomer {{variant}}-Themen-Logo herunterladen',
      datomerLogoVariantAlt: 'Datomer {{variant}} Themen-Logo Variante',
      datomerBannerVariations: 'Datomer Banner-Variationen im Themen-Design',
      datomerBannerVariationsText: 'Datomer-Banner-Variationen für LinkedIn und andere Kanäle.',
